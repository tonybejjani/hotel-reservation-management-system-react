...
function SlideLeftPanel({ openWindow }) {
  ...
  return (
    ...
    >
      <PageWrapper>
        <Stacked isMobile={isMobileView} isDarkMode={isDarkMode}>
          <Row type="horizontal">
            <Heading as="h1">
              ...
              {openWindow === 'add-guest' && 'New Guest'}
              {openWindow === 'add-cabin' && 'New Cabin'}
            </Heading>
          </Row>
        ...
        <Row>
          {openWindow === 'add-booking' && (
            <AddBooking isMobile={isMobileView} />
          )}
          {openWindow === 'add-guest' && (
            <CreateGuestFormMobile isMobile={isMobileView} />
          )}
          {openWindow === 'add-cabin' && (
            <CreateCabinFormMobile isMobile={isMobileView} />
          )}
        </Row>
      </PageWrapper>
    </motion.div>
